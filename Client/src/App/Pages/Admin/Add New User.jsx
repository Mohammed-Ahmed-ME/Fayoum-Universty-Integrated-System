...
const AddNewUser = () => {
    ...
    const { currentColor,UserData } = useStateContext();
        if(UserData.role !== "Full Administrator")
        {
            ...
            return (
        <div className="mt-10">
            <h1 className="flex flex-wrap lg:flex-nowrap justify-center text-3xl font-bold pb-4 items-center text-center sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl" style={{ color: currentColor }}>Add New User</h1>
