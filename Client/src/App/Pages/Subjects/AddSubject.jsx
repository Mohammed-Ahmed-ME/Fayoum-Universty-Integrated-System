...
import { PostStudentSubject} from "../../API/API";
...
const AddSubject = () => {
    ...
    const Add= async (e) => {
        ...
        try {
            ...
            const Add = await PostStudentSubject(subjectData);
    ...
    return (
        <div className="mt-10">
            <h1 className="flex flex-wrap lg:flex-nowrap justify-center text-3xl font-bold pb-4 items-center text-center sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl" style={{ color: currentColor }}>Add New Subject</h1>
            <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
                <Header category="Form" title="Post Subject" />
                <form onSubmit={Add}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col">
                            <label htmlFor="SubjectName" className="font-semibold mb-2">
                                Subject Name:
                            </label>
                            <input
                                id="name"
