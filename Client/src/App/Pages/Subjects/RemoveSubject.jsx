...
import { DeleteStudentSubject} from "../../API/API";
...
const RemoveSubject = () => {
    ...
    const Remove = async (e) => {
        ...
        try {
            ...
            const Add = await DeleteStudentSubject(subjectData);
    ...
    return (
        <div className="mt-10">
            <h1 className="flex flex-wrap lg:flex-nowrap justify-center text-3xl font-bold pb-4 items-center text-center sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl" style={{ color: currentColor }}>Remove Subject</h1>
            <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
                <Header category="Form" title="Remove Subject" />
